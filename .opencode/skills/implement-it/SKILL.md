...
- (optional) Use JIRA and Unblocked to fetch the ticket and its dependencies.
...
- If the ticket is ambiguous, list assumptions made to clarify the implementation.
- If ticket is complex, list constraints that limit the solution space.
- If ticket is simple, you can skip this section.
